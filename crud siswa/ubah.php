...
// Mengambil data dari table produk dari id yang tidak sama dengan 0
...
<body>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="fw-bold text-uppercase"><i class="bi bi-pencil-square"></i>&nbsp;Ubah Data produk</h3>
            </div>
            <hr>
        </div>
        <div class="row my-2">
            <div class="col-md">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control w-50" id="id" value="<?= $produk['id']; ?>" name="id" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="nama" class="form-label">Nama Produk</label>
                        <input type="text" class="form-control w-50" id="nama_produk" value="<?= $produk['nama_produk']; ?>" name="nama_produk" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                        <label for="gambar" class="form-label">Gambar <i>(Saat ini)</i></label> <br>
                        <img src="img/<?= $produk['gambar']; ?>" width="50%" style="margin-bottom: 10px;">
                        <input class="form-control form-control-sm w-50" id="gambar" name="gambar" type="file">
                    </div>
                    <div class="mb-3">
                        <label for="deskripsi" class="form-label">deskripsi</label>
                        <textarea class="form-control w-50" id="deskripsi" rows="5" name="deskripsi" autocomplete="off"><?= $produk['deskripsi']; ?></textarea>
                    </div>
                    <hr>
    ...
    <footer class="bg-dark text-white text-center" style="padding: 5px;">
        <p>Created with <i class="bi bi-suit-heart-fill" style="color: red;"></i> by <a href="https://instagram.com/vikrysurya_" target="_blank" style="color: #fff;">M-One</a></p>
    </footer>
    <!-- Close Footer -->
