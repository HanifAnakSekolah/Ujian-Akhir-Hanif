...
// Menampilkan semua data dari table produk berdasarkan id secara Descending
...
<body>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="text-center fw-bold text-uppercase">Data Produk M-One</h3>
                <hr>
            </div>
        </div>
        <div class="row my-2">
            <div class="col-md">
                <a href="addData.php" class="btn btn-primary"><i class="bi bi-plus-circle"></i>&nbsp;Tambah Data</a>
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title fw-bold text-uppercase" id="detail">Detail Produk</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body text-center" id="detail-produk">
                </div>
            </div>
        </div>
    </div>
    ...
    <footer class="bg-dark text-white text-center" style="padding: 5px;">
        <p>Created with by <u style="color: #fff;">Hanif Hawari</u></p>
    </footer>
    <!-- Close Footer -->
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.detail').click(function() {
                var dataproduk = $(this).attr("data-id");
                $.ajax({
                    url: "detail.php",
                    method: "post",
                    data: {
